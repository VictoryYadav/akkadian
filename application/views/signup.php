<?php 
$user_type = array('1' => 'Corporate', '0' => 'Individual');
if( isset($_GET['type']) && $_GET['type'] == 2){
    $user_type = array('5' => 'Corporate', '6' => 'Individual');
}
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <form method="post" action="<?php echo base_url('register'); ?>">
                                            ...
                                            <div class="form-group">
                                                <input type="tel" name="mobile" required class="form-control" placeholder="Mobile *" value="" maxlength="10" minlength="10" />
                                            </div>
                                            ...
                                            <div class="text-center">
                                                ...
                                                <small><a href="<?php echo base_url('login'); ?>">Log In</a>
                                                    </small>
                                            </div>
                                        </form>
                                    </div>
