...
<div class="container register">
                <div class="row" style="opacity: 65%;">
                    <div class="col-md-3 register-left">
                        ...
                        <a href="<?= base_url()?>home/register" class="btn btn-primary">Register</a>
                    </div>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <?php if(!empty($_SESSION['login_error']) && $_SESSION['login_error'] == 1){?>
                                            <span class="text-danger"><b>Invalid Credentials</b></span>
                                        <?php 
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="text-danger"><b><?php echo form_error('email'); ?></b></span>
                                            </div>
                                            <div class="form-group">
