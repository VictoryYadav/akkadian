                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="<?php echo base_url('dashboard'); ?>" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="<?= base_url() ?>assets_admin/images/akk_logo.jpg" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?= base_url() ?>assets_admin/images/akk_logo.jpg" alt="" height="17">
                                </span>
                            </a>
                            ...
                            <a href="<?php echo base_url('dashboard'); ?>" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="<?= base_url() ?>assets_admin/images/akk_logo.jpg" alt="" style="height: 70px;">
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <img class="rounded-circle header-profile-user" src="<?= base_url() ?>assets_admin/images/users/user-1.jpg"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ml-1"><?php echo authuser()->username; ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('auth/change_password'); ?>"><i class="dripicons-lock d-inlne-block text-muted mr-2"></i> Change Password</a>
