...
<body style="background: #000;color: #FFF">
	<div class="container-fluid">
		...
		<form method="post">
			<!-- <div class="text-center"><h2>Add General Info</h2></div>
			<div id="general_info">
				<div class="row">
					...
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="company_turnover" placeholder="Company Turnover" required>
						</div>
					</div>
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							<label for="industry_sector">Industry</label>
							<input type="text" class="form-control" name="industry_sector" placeholder="Industry" required>
						</div>
					</div>
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							<label for="no_of_outlets">Sector</label>
							<input type="text" class="form-control" name="no_of_outlets" placeholder="Sector" required>
						</div>
					</div>
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							<label for="no_of_units">No of Units/Outlets</label>
							<input type="number" class="form-control" name="no_of_units" placeholder="No of Units/Outlets" required>
						</div>
					</div>
					<div class="col-sm-12 col-md-6">
						<div class="form-group">
							<label for="attrition">Attrition(%)</label>
							<input type="number" max="100" class="form-control" name="attrition" placeholder="Attrition" required>
						</div>
					</div>
				</div>
			</div>
