                                    ...
                                    <div class="col-md-6">
                                        <form method="post">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="name" required placeholder="Name" value="<?php echo set_value('name'); ?>" />
                                                <span class="text-danger"><b><?php echo form_error('name'); ?></b></span>
                                            </div>
                                            <!-- <div class="form-group">
